...
| Check | Result |
|---|---|
| W36 unit and adversarial tests | PASS — 17/17 |
| Existing W31 and W35 regressions | PASS — 16/16 |
| Full foundry suite | PASS — 33/33 |
| One-minute validate/run/verify/replay demo | PASS |
| Receipt tamper and malicious re-hash detection | PASS |
| Source no-clobber and path containment | PASS |
...
| Promotion review | PENDING — dedicated promotion pull request, fully validated |
